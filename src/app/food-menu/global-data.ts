  ...
  PorsiMenus: [
    {
      ...
      image: "/images/food-menu/porsi-3.jpg",
      mainFood: ["چلو ماهیچه"],
    ...
    {
      title: "منو پرسی 2",
      image: "/images/food-menu/porsi-2.jpg",
      description:
        "مجموعه‌ای کامل از غذاهای اصلی، نوشیدنی‌ها، سالاد و پذیرایی عصرانه برای مهمانی‌های باشکوه.",
    ...
    {
      title: "منوی پرسی ۳",
      image: "/images/food-menu/porsi-4.jpg",
      description:
        "مجموعه‌ای کامل از غذاهای اصلی، نوشیدنی‌ها، سالاد و پذیرایی عصرانه برای مهمانی‌های باشکوه.",
      mainFood: [
  ...
  SelfMenus: [
    {
      ...
      image: "/images/food-menu/self2.jpg",
      mainFood: [
        "برنج سفید زعفرانی",
        "باقالا پلو با گوشت",
        "شیرین پلو با مرغ",
    ...
    },
    {
      ...
      image: "/images/food-menu/self3.jpg",
      mainFood: [
        "برنج سفید زعفرانی",
        "باقالا پلو با گوشت",
        "شیرین پلو با مرغ",
    ...
    },
    {
      ...
      image: "/images/food-menu/self1.jpg",
      mainFood: [
        "برنج سفید زعفرانی",
        "باقالا پلو با گوشت",
        "شیرین پلو با مرغ",
    ...
    {
      title: "منوی سلف ۴",
      image: "/images/food-menu/self4.jpg",
  ...
  SelectedMenu: [
    {
      ...
      description:
        "منوی متنوع با غذاهای ایرانی محبوب و خدمات کامل برای مراسم شیک.",
      image: "/images/food-menu/kabab.jpg",
      mainFood: [
        "گوشت درسته",
        "مرغ بریان",
        "بوقلمون",
    ...
    },
    {
      ...
      description:
        "منوی متنوع با غذاهای ایرانی محبوب و خدمات کامل برای مراسم شیک.",
      image: "/images/food-menu/beef.jpg",
      mainFood: [
        "گوشت درسته",
        "مرغ بریان",
        "بوقلمون",
