...
export const menuData: MenuItem[] = [
  ...
  {
    title: "منوی سلف VIP",
    image: "/images/landing-images/about-slider-2.webp",
    description:
      "پکیج کامل تشریفات و پذیرایی VIP با انتخاب‌های متنوع غذا، دسر، سالاد و خدمات ویژه.",
    ...
    sections: [
      ...
      {
        title: "اردور و فینگرفود",
        items: ["اردور", "فینگرفود"],
      },
      {
        title: "پذیرایی عصرانه",
        items: ["میوه ۶ نوع", "شیرینی ۵ نوع", "کافه گلاسه همراه با آبمیوه"],
