...
export default function WeddingPackage() {
  return (
    <div className="flex flex-col items-center w-full gap-6">
      ...
      <div className="flex justify-between gap-5 w-full flex-col md:flex-row md:flex-wrap lg:flex-nowrap">
        <div
          className={clsx(
            ...
            "border-2 border-solid border-[var(--brown)] justify-between h-full"
          )}
        >
          <Image
        ...
        <div
          className={clsx(
            "min-h-full flex-1 rounded-2xl flex items-end md:p-5 gap-5 cursor-pointer relative group",
            "wedding-package"
          )}
        >
          <Image
          ...
          <div
            className={clsx(
              "flex flex-col justify-between w-full h-9/10 gap-2.5",
          ...
          >
            <Image
              ...
              width={60}
              alt="box icon"
              className="object-cover drop-shadow-[0_0_30px_black]"
            />
        ...
        <div
          className={clsx(
            ...
            "w-full lg:min-w-auto lg:w-1/4 wedding-package h-full",
