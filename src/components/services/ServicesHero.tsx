  ...
  return (
    <div className="pt-[90px] relative w-[100%] h-[100vh] p-10 max-md:p-2.5 max-md:pt-[90px]">
      <div className="relative w-full h-full z-10">
        ...
        />
        <div className="absolute gap-5 z-20 top-0 left-0 right-0 bottom-0 bg-gradient-to-b from-[rgba(0,0,0,0.3)] rounded-2xl to-[rgba(0,0,0,0.7)] flex flex-col justify-start pt-20 text-[#F7F1EA] p-10  
        2xl:pt-30 2xl:px-15 max-md:p-5 max-md:pt-20
        ">
          <h2 className="text-5xl font-bold 2xl:text-6xl max-md:text-4xl max-sm:text-2xl">تبدیل داستان عشق شما به</h2>
          <b className="text-3xl 2xl:text-4xl max-md:text-2xl max-sm:text-lg">لحظات ماندگار عروسی</b>
